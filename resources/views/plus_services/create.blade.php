...
@section('breadcrumbs')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tambah Daftar Plus Service</li>
        </ol>
    </nav>
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Tambah Plus Service</h4>
                    </div>
                    @if (session('error'))
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('plus-service.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <!-- Nama Service Plus -->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" class="form-control" name="name"
                                            value="{{ old('name') }}" placeholder="Penghilang Bau Sepatu">
                                    </div>
                                </div>
