            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Tambah Kategori Blog</h4>
                    </div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('kategori-blog.store') }}">
                            @csrf
                            <div class="form-group row align-items-center">
                                <label class="col-lg-3 col-form-label" for="name_category_blog">Nama Kategori Blog</label>
                                <div class="col-lg-9">
                                    <input type="text" id="name_category_blog" class="form-control" name="name_category_blog"
                                        value="{{ old('name_category_blog') }}" placeholder="Nama Kategori Blog">
                                </div>
                            </div>

                            <div class="row mt-3">
                                <div class="col-12 d-flex justify-content-end">
                                    <a href="{{ route('kategori-blog.index') }}" class="btn btn-primary rounded-pill me-1 mb-1">
                                        Batal
                                    </a>
